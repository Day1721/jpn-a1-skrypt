...
\begin{document}
	...
	\newpage
	\section{Lekcja 8(11月21日)}
	\subsection{Kanji}
	\kanji{行}{iść (gdzieś), "to go"}{い}{こう}
	\subsection{Słowa}
	\vocab{おおさかのおばちゃん}{}{Dziwne panie w Osaki} \\
	\vocab{あかちゃん}{}{niemowlak} \\
	\vocab{あかんぼう}{}{niemowlak} \\
	\vocab{ひい\textasciitilde}{}{pra\textasciitilde (np. pradziadek)}
	\subsubsection{Rodzina (かぞく)}
	\begin{tabularx}{\textwidth}{@{}Y|Y|Y@{}}
	Moja & Czyjaś & Tłumaczenie \\ \hline
	はは & おかあさん & Mama \\
	ちち & おとうさん & Tata \\
	あね & おねえさん & Starsza siostra \\
	いもうと & いもうとさん & Młodsza siostra \\
	あに & おにいさん & Straszy brat \\
	おとうと & おとうとさん & Młodszy brat \\
	おば & おばさん & Ciocia \\
	おじ & おじさん & Wujek \\
	そば & おばあさん & Babcia \\
	そふ & おじいさん & Dziadek \\
	むすめ & むすめさん & Córka \\
	むすこ & むすこさん & Syn \\
	こども & こどもさん/お\fur{子}{こ}さん & Dziecko \\
	まご & まごさん & wnuk　(wnuczka ??) \\
	いとこ & いとこさん & Kuzyn/kuzynka \\
	しゅじん & ごしゅじん & Właściciel, pan, mąż\footnotemark \\
	だんな & だんなさん & mąż \\
	おっと & & mąż \\
	かない & & żona\footnotemark[5] \\
	つま & おくさん & żona
	\end{tabularx}
	\footnotetext[5]{rzadko używane w tym znaczeniu}
	\subsubsection{Dni/tygodnie (względnie) (?)}
	\begin{multicols}{2} \noindent
		\vocab{おととい}{}{przedwczoraj} \\
		\vocab{きのう}{}{wczoraj} \\
		\vocab{きょう}{}{dzisiaj} \\
		\vocab{あした}{}{jutro} \\
		\vocab{あさって}{}{pojutrze} \\
		\vocab{せんしゅう}{}{zeszły tydzień} \\
		\vocab{こんしゅう}{}{ten tydzień} \\
		\vocab{らいしゅう}{}{przyszły tydzień} \\ 
	\end{multicols}
	\subsubsection{Częstotliwość}
	\vocab{いつも}{}{zawsze} \\
	\vocab{まいにち}{}{codziennie} \\
	\vocab{たいてい}{}{zazwyczaj} \\
	\vocab{よこ}{}{często} \\
	\vocab{ときどき}{}{czasami} \\
	\vocab{たまに}{}{od czasu do czasu} \\
	\vocab{あまり}{}{niezbyt (przeczenie)} \\
	\vocab{ぜんぜん}{}{wcale/w ogóle (przeczenie)}
	\subsection{Gramatyka}
	\subsubsection{Czas przeszły}
	きのうはげつようび\underline{でした}。: Wczoraj był poniedziałek. \\
	おとといはにちようび\underline{でした}か。: Czy przedwczoraj była niedziela?
	\subsubsection{Przeczenie}
	 - きのうはにちようび じゃなかったです。
	 - きのうはにちようび じゃありませんでした。
	\subsection{Wyrażenia}
	きょうはなんようびですか。: Jaki dzisiaj mamy dzień (tygodnia)? \\
	あしたはなんようびですか。: Jaki jutro mamy dzień (tygodnia)? \\
	きょうはなんがつなんにちですか。: Jaką mamy dziś datę? \\
	こんしゅうのきんようびははなんがつなんにちですか。: W tym tygodniu w piątek jaka będzie data? \\
	まいにちきっさてんに\fur{行}{い}きます。: Codziennie chodzę do kawiarni. \\
	ぜんぜんさかなやに\fur{行}{い}きません。: Nigdy nie chodzę do sklepu rybnego. \\
	よくどこに\fur{行}{い}きますか。: Gdzie często chodzisz?
	
	\newpage
	\section{Lekcja 9(11月28日)}
	\subsection{Kanji}
	\kanji{月}{Księżyc, miesiąc, 'poniedziałek'}{つき}{がつ、げつ}
	\kanji{火}{Ogień, 'wtorek'}{ひ}{か}
	\kanji{水}{Woda, 'środa'}{みず}{すい}
	\kanji{木}{Drzewo, 'czwartek'}{き}{もく}
	\kanji{金}{Złoto, pieniądze, 'piątek'}{かね}{きん}
	\kanji{土}{Gleba, 'sobota'}{つち}{ど}
	\kanji{日}{Dzień, 'niedziela'}{ひ、び}{にち、じつ、に}
	\kanji{曜}{Dzień tygodnia}{-}{よう}
	\kanji{何}{Pytanie}{なに、なん}{?}
	\subsection{Słowa}
	\vocab{火山}{かざん}{Wulkan} \\
	\vocab{お金}{おなね}{Pieniądze} \\
	\vocab{どこも}{}{nigdzie} \\
	\vocab{たべる}{}{jeść} \\
	\vocab{すいはんき}{}{maszyna do gotowania ryżu} \\
	\vocab{あるいて}{}{pieszo} 
	\subsubsection{Środki lokomocji}
	\begin{multicols}{2} \noindent
		\vocab{じてんしゃ}{}{rower} \\
		\vocab{くるま}{}{auto} \\
		\vocab{ちかてつ}{}{metro} \\
		...
		\vocab{バース}{}{autobus} \\
		\vocab{トラム}{}{tramwaj} \\
		\vocab{ろめんでんしゃ}{}{tramwaj} \\
		\vocab{ひこうき}{}{samolot} \\
		\vocab{ふね}{}{statek} \\
		\vocab{バイク}{}{motor/skuter} \\
		\vocab{うま}{}{koń} \\
		\vocab{トラック}{}{ciężarówka} \\
		\vocab{ローラースケート}{}{rolki} \\
		\vocab{ヘリ}{}{helikopter} \\
		\vocab{スケーター}{}{hulajnoga} \\
		\vocab{スケートボード}{}{deskorolka} \\
		\vocab{せんしゃ}{}{czołg} \\
		\vocab{ききゅう}{}{balon} \\
		\vocab{ばしゃ}{}{pojazd konny} \\
		\vocab{タクシー}{}{taxi} \\
	\end{multicols}
	\subsection{Jedzenie}
	\begin{multicols}{2} \noindent
		\vocab{いりたまご/}{}{jajecznica} \\
		\vocab{スクランブルエッグ}{}{jajecznica} \\
		\vocab{オムレツ}{}{omlet} \\
		\vocab{\fur[1]{生}{なま}たまご}{}{jajko na surowo} \\
		\vocab{ゆでたまご}{}{jajko na twardo} \\
		\vocab{めだまやき}{}{jajko sadzone (dosłownie, smażone oko)} \\
		\vocab{はんじゅくたまご}{}{jajko miękko} \\
		\vocab{パンケーキ}{}{naleśniki} \\
		\vocab{たまごやき}{}{omlet zwijany} \\
		\vocab{オムライス}{}{wielki pieróg} \\
		\vocab{ごはん}{}{gotowany ryż} \\
		\vocab{こめ}{}{ryż} \\
		\vocab{サンドイッチ}{}{kanapka} \\
		\vocab{まぐろ}{}{tuńczyk ryba (?)}
	\end{multicols}
	\subsection{Gramatyka}
	\subsubsection{Partykuła に}
	\begin{minipage}[t]{0.97\textwidth}
		$\underset{\text{dzień tygodnia}}{\fur{月曜日}{げつようび}}\underset{\text{w}}{に}\underset{\text{miejsce}}{プール}\underset{\text{do}}{に}$\fur{行}{い}きます。: W poniedziałki chodzę na basen. \\
		\fur{何曜日}{なんようび}にレストランに\fur{行}{い}きます。: W jaki dzień tygodnia chodzisz do restauracji.
	\end{minipage}
	\hfill
	\fbox{\begin{minipage}[t]{0.12\textwidth}
			...
			- godziny
	\end{minipage}}
	せんしゅうの\fur{金曜日}{きんようび}にえいがかんに\fur{行}{い}きますか。: Czy w zeszłym tygodniu w piątek byłeś w kinie? \\
	どこも\fur{行}{い}きません。: Nigdzie nie pojadę. \\
	\fur{4月}{しがつ}\fur{1日}{ついたち}に\fur{日本}{にほん}に\fur{行}{い}きます。: 1. kwietnia lecę do Japonii. \\
	\fur{何日}{なんにち}にフランスに\fur{行}{い}きますか。: Którego dnia miesiąca pojechałeś do Francji?
	\subsubsection{Partykuła で}
	\begin{minipage}[t]{0.82\textwidth}
		くるまで\fur{大学}{だいがく}に\fur{行}{い}きます。: Jeżdżę na uczelnię samochodem. \\
		\fur{何}{なに}で\fur{学校}{がっこう}に\fur{行}{い}きますか。: Czym jeździsz do szkoły?
	\end{minipage}
	\hfill
	\fbox{\begin{minipage}[t]{0.27\textwidth}
			- za pomocą czegoś
	\end{minipage}}
	いつも\fur{何}{なに}でたいしかんに\fur{行}{い}きます。: Czym zawsze jeździsz do ambasady?
	\subsubsection{Partykuła の}
	\begin{minipage}[t]{0.97\textwidth}
		でんしゃとちかてつでりょかんに\fur{行}{い}きます。: Jeżdżę do hotelu pociągiem i metrem. \\
		ははとちちと\fur{日本}{にほん}に\fur{行}{い}きます。: Pojadę do Japonii z mamą i tatą. \\
		だれとアメリカに\fur{行}{い}きますか。: Z kim pojedziesz do Ameryki?
	\end{minipage}
	\hfill
	\fbox{\begin{minipage}[t]{0.12\textwidth}
			- i, z
	\end{minipage}}
	\subsubsection{Czasownik たべる}
	たべます: jem (tw., ter.-przyszły) \\
	たべません: nie jem (odm. (?), ter.-przyszły) \\
	たべました: jadłem (tw., przeszły) \\
	たべませんでした: nie jadłem (odm., przeszły)
	\subsection{Wyrażenia}
	あさ\fur{何}{なに}をたべますか。: Co jesz rano?
\end{document}